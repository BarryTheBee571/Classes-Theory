...
player_weapon = Weapon('Hammer of Hephaestus', 'Big Hammer', random.randint(12,15))
# TODO: Create an instance of Enemy with random damage between 15 and 18, and random health between 80 and 140
enemy_character = Enemy('Yyoung Du', 'Chinese', random.randint(15,18), random.randint(80,140))
